...
function init() {
	...
	var square = new THREE.Mesh( geometry, new THREE.MeshLambertMaterial( { emissive: 0x0000FF, emissiveIntensity: 1 } ) ); //blu
	...
	var mazeBackground = new THREE.Mesh(squareBack, new THREE.MeshLambertMaterial( { emissive: 0xffffff, emissiveIntensity: 1})); //riga verticale a sinistra
...
/*
	...
	var circleGoal = new THREE.Mesh(square2, new THREE.MeshLambertMaterial( { emissive: 0x7FFF00, emissiveIntensity: 1}));
	...
	var circleStart = new THREE.Mesh(square2, new THREE.MeshLambertMaterial( { emissive: 0xFF0000, emissiveIntensity: 1 }));
	...
	var circleUnlock1 = new THREE.Mesh(circle, new THREE.MeshLambertMaterial({  emissive: 0x800080, emissiveIntensity: 1 }));
	...
	var circleUnlock2 = new THREE.Mesh(circle, new THREE.MeshLambertMaterial( {emissive: 0xFFFF00, emissiveIntensity: 1}));
	...
	var circleUnlock3 = new THREE.Mesh(circle, new THREE.MeshLambertMaterial( { emissive: 0xFF69B4, emissiveIntensity: 1}));
	...
	var circleUnlock4 = new THREE.Mesh(circle, new THREE.MeshLambertMaterial( { emissive: 0xff4300, emissiveIntensity: 1}));
	...
	var circleUnlock5 = new THREE.Mesh(circle, new THREE.MeshLambertMaterial( { emissive: 0xD2691E, emissiveIntensity: 1}));
	...
	var circleUnlock6 = new THREE.Mesh(circle, new THREE.MeshLambertMaterial( { emissive: 0xb04949, emissiveIntensity: 1}));
...
function moveSq() {
	...
	if (keyboard.pressed("down")) { //down arrow
	...
	if (keyboard.pressed("left")) { //left arrow
	...
	if (keyboard.pressed("right")) { //right arrow
